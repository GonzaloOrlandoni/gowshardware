    ...
    <div className="container mx-auto max-w-3xl px-4 py-12 text-slate-300">
      ...
      <div className="space-y-6 bg-white/5 backdrop-blur-md p-8 rounded-2xl shadow-sm border border-white/10">
        ...
        <section>
          ...
          <p>
            Todos los componentes comercializados cuentan con la garantía
            oficial del fabricante. El período de garantía varía según la marca,
            siendo típicamente de 12 a 36 meses. Para tramitar RMA, es necesario
        ...
        <section>
          ...
          <p>
            Los tiempos de envío son estimativos. GOWS Hardware no se
            responsabiliza por demoras ocasionadas por las empresas de logística
            (Correo Argentino, Andreani) una vez despachado el producto.
          </p>
        </section>
      </div>
    </div>
