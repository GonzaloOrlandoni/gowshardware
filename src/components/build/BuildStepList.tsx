  ...
  return (
    <div className="space-y-4">
      {steps.map((step) => {
        ...
        const isMaxReached =
          step.multi && selectedItems.length >= (step.max || 1);
        ...
        return (
          <div
            key={step.id}
            className={`overflow-hidden rounded-xl border transition-all ${containerClass}`}
          >
            <div className="flex items-center justify-between p-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p
                    className={`text-sm ${hasSelection ? "font-medium text-orange-700" : "text-slate-400"}`}
                  >
                    {hasSelection
                      ? step.multi
